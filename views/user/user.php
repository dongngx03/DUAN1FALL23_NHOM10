...
<script>
        ...
        function validateForm(event) {
            if (errPhone.textContent != '' || errEmail.textContent != '' || errUser.textContent != '' || errPass.textContent != '' || errTinh.textContent != '' || errXa.textContent != ''|| errHuyen.textContent != '' || errDiachi.textContent != '' || errMota.textContent != '') {
