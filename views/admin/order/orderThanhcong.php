<?php 
    include'./controllers/admin/order/orderThanhcongController.php';
?>
<style>
    <?php 
...
<div class="container-fluid">
    <div class="row d-flex justify-content-center">
        <div class="col-md-11 p-3 bg-light mt-2 shadow-sm rounded">
            <h3 class="text-secondary h4">Đơn Hàng Thành Công </h3>
        </div>
                ...
                <tbody id="variant_list">
                   ...
                   <?php 
                        if(empty($dataOrder)) {
                            echo '
                                <tr >
                                    <th colpan="5" scope="row" class="text-center">không có đơn hàng giao thành cồng nào </th>
                                </tr>
                            ';
                        }
                   ?>
